CREATE DATABASE  IF NOT EXISTS `healthcare_qa` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `healthcare_qa`;
-- MySQL dump 10.13  Distrib 8.0.41, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: healthcare_qa
-- ------------------------------------------------------
...
--
-- Dumping events for database 'healthcare_qa'
--

--
-- Dumping routines for database 'healthcare_qa'
--
...
-- CREDENTIALS (ADMIN)
INSERT INTO `healthcare_qa`.`credentials` (
    `phone`,
    `email`,
    `password_hash`,
    `role`
...
-- ADMINS
INSERT INTO `healthcare_qa`.`admins` (
    `first_name`,
    `last_name`,
    `credential_id`
) VALUES (
...
-- SERVICE CHECK
SELECT * FROM `healthcare_qa`.`service`;

-- SERVICE INSERT
INSERT INTO `healthcare_qa`.`service` (
    `id`,
    `name`,
    `price`
) VALUES (
...
-- SPECIALIZATIONS
INSERT INTO `healthcare_qa`.`specializations` (
    `id`,
    `name`
) VALUES (
    1,
...
INSERT INTO `healthcare_qa`.`service-specializations` (
    `service_id`,
    `specialization_id`
) VALUES (
    1,
...
INSERT INTO `healthcare_qa`.`doctors`
    (`first_name`,
    `last_name`,
    `specialization_id`,
    `credential_id`,
...
INSERT INTO `healthcare_qa`.`patients`
(
`first_name`,
`last_name`,
`credential_id`,
